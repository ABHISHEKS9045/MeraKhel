...
import merakhel.fantasy.payments.PaytmHandler
import merakhel.fantasy.ui.home.models.UsersPostDBResponse
import merakhel.fantasy.utils.BindingUtils.Companion.GOOGLE_TEZ_PACKAGE_NAME
import merakhel.fantasy.utils.BindingUtils.Companion.PAYMENT_GOOGLEPAY_UPI
import merakhel.fantasy.utils.MyPreferences
import merakhel.fantasy.utils.MyUtils
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response
import merakhel.fantasy.databinding.ActivityAddMoneyBinding
import java.util.*
...
//        })
    ...
    private fun payUsingGooglePay(amount: Double) {
        ...
        if (isAppInstalled(GOOGLE_TEZ_PACKAGE_NAME)) {
            // showProgress();
            val upiId: String = PAYMENT_GOOGLEPAY_UPI

            val uri = Uri.Builder()
                .scheme("upi")
                .authority("pay")
                .appendQueryParameter("pa", upiId)
                .appendQueryParameter("pn", "Mera Khel")
