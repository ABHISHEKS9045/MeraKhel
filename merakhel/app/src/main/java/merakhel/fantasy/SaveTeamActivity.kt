...
import merakhel.fantasy.listener.OnRolesSelected
import merakhel.fantasy.databinding.ActivitySaveTeamBinding
import merakhel.fantasy.CreateTeamActivity.Companion.CREATE_TEAM_ALLROUNDER
import merakhel.fantasy.CreateTeamActivity.Companion.CREATE_TEAM_BATSMAN
import merakhel.fantasy.CreateTeamActivity.Companion.CREATE_TEAM_BOWLER
import merakhel.fantasy.CreateTeamActivity.Companion.CREATE_TEAM_WICKET_KEEPER
...
import merakhel.fantasy.network.RequestCreateTeamModel
import merakhel.fantasy.network.WebServiceClient
import merakhel.fantasy.ui.BaseActivity
import merakhel.fantasy.ui.contest.MyTeamFragment
import merakhel.fantasy.ui.createteam.adaptors.PlayersSelectedAdapter
import merakhel.fantasy.ui.createteam.models.PlayersInfoModel
import merakhel.fantasy.ui.home.models.UsersPostDBResponse
import merakhel.fantasy.ui.login.RegisterScreenActivity
...
//        BindingUtils.logD("TimerLogs", "initViewUpcomingMatches() called in ContestActivity")
        ...
        BindingUtils.countDownStart(matchObject!!.timestampStart, object : OnMatchTimerStarted {
            ...
            override fun onTicks(time: String) {
                ...
                mBinding!!.matchTimer.setTextColor(resources.getColor(R.color.black))
