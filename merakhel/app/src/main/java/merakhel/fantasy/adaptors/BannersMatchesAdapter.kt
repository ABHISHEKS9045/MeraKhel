package merakhel.fantasy.adaptors
...
import merakhel.fantasy.InviteFriendsActivity
import merakhel.fantasy.SupportActivity
import merakhel.fantasy.models.MatchBannersModel
import merakhel.fantasy.utils.BindingUtils
import merakhel.fantasy.R


abstract class BannersMatchesAdapter(val context: Context, val tradeinfoModels: ArrayList<MatchBannersModel>) :
...
//    }
    ...
    class BannerMatchesViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
