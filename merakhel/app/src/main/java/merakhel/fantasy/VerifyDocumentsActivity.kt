...
import merakhel.fantasy.models.DocumentsModel
import merakhel.fantasy.models.ResponseModel
...
import merakhel.fantasy.databinding.ActivityVerifyDocumentBinding
...
class VerifyDocumentsActivity : BaseActivity() {
    ...
    private fun initDocuments() {
        ...
        mBinding!!.txtSelectPancrd.setOnClickListener(View.OnClickListener {
            ...
            mBinding!!.txtSelectAdharcard.setBackgroundResource(R.drawable.button_selector_grey11)
        ...
        mBinding!!.txtSelectAdharcard.setOnClickListener(View.OnClickListener {
            ...
            mBinding!!.txtSelectPancrd.setBackgroundResource(R.drawable.button_selector_grey11)
            mBinding!!.txtSelectPancrd.setTextColor(resources.getColor(R.color.white))
...
//a1:d6:f8:87:cd:93:f5:7a:9e:4e:9e:b8:00:ba:4f:af:5a:06:99:f3
//a9:8e:bf:3f:c0:d2:bc:62:b4:19:00:4f:03:db:d0:26:3a:17:f1:ca:b4:6e:25:2b:3d:b1:39:22:aa:7a:3e:37