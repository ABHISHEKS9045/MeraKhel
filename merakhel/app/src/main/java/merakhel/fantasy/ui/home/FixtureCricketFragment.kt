package merakhel.fantasy.ui.home
...
import merakhel.fantasy.adaptors.MatchesAdapter
import merakhel.fantasy.listener.RecyclerViewLoadMoreScroll
...
import merakhel.fantasy.databinding.FragmentAllGamesBinding
...
class FixtureCricketFragment : Fragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun onCreateView(
        ...
        mBinding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_all_games, container, false
        )
...
//            mSnackbar.show()
        ...
        WebServiceClient(requireActivity()).client.create(IApiMethod::class.java).getAllMatches(models)
