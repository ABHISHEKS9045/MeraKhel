...
import merakhel.fantasy.databinding.FragmentPrizeBreakupBinding
...
import merakhel.fantasy.ui.leadersboard.models.PrizeBreakUpModels
...
class PrizeBreakupFragment(
    ...
    fun getPrizeBreakup() {
       ...
       // models.token =MyPreferences.getToken(activity!!)!!
        ...
        WebServiceClient(requireActivity()).client.create(IApiMethod::class.java).getPrizeBreakUp(models)
