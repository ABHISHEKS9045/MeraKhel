...
import merakhel.fantasy.databinding.FragmentTransactionHistoryBinding
...
class TransactionFragment(myAccountFragment: MyAccountFragment) : Fragment() {
    ...
    fun getMyTransaction() {
        ...
        WebServiceClient(requireActivity()).client.create(IApiMethod::class.java).getTransactionHistory(models)
