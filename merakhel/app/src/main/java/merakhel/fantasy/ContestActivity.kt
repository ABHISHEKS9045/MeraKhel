...
import merakhel.fantasy.databinding.ActivityContestBinding
...
import merakhel.fantasy.ui.contest.ContestFragment
import merakhel.fantasy.ui.contest.MyContestFragment
...
//        this.collapseMenu = menu
    ...
    private fun setupViewPager(viewPager: ViewPager) {
        ...
        adapter.addFragment(MyContestFragment(matchObject), getString(
            R.string.contest_type_mycontest
        ))
        adapter.addFragment(MyTeamFragment(matchObject), getString(
